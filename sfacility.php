  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">ADD NEW FACILITIES</h5>
      ...
      <div class="modal-body">
        <form>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Enter facilities name:</label>
            <input type="text" class="form-control" id="recipient-name">
          </div>
          <div class="form-group">
            <label for="message-text" class="col-form-label">Enter facilities description</label>
 ...
 <table id="example23" class="table table-bordered table-striped">
  ...
  <tbody>
    <tr >
        <td>1</td>
        <td ><a>Swimming</a></td>
        <td>Help in cardiovascular health of the student</td>
        <!--td>400101</td>
        <td>MSBTE</td>
    ...
    <tr >
        <td>2</td>
         <td>Cricket</td>
        <td>Improve the cricket skills of the student</td>
         <!--td>3463373575</td>
